 ...
 * clic sur la carte positionne toujours l'actif, jamais les autres, LIBREMENT
 * (même hors du cercle de portée max de la Mesange, affiché comme repère et
 * signalé en rouge si dépassé, jamais bloquant).
 */
  ...
  return (
    <div className="mx-auto flex h-full max-w-5xl flex-col gap-4">
      <p className="text-sm font-medium text-ink-dim">
        Place {radars.length > 1 ? 'each radar' : 'the radar'} anywhere on the map — the circle shows the
        rocket's reach ({ROCKET_MAX_RANGE_KM} km max)
      </p>
