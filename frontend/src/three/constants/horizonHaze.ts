...
/** Densité globale (0-1) : opacité max au niveau le plus bas du dégradé. */
export const HAZE_DENSITY = 0.85
 ...
 *  voir useHorizonHazeMaterial : la brume « attrape » la lumière au lieu de
 *  rester une teinte plate uniforme. Plus chaude/saturée que FOG_COLOR. */
export const HAZE_SUN_TINT = '#ffb877'
